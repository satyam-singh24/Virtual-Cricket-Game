// This Code is Wriiten by: Satyam Kumar
#include <bits/stdc++.h>
using namespace std;
...
Game::Game()
{
    ...
    players[4] = "Shivam Dubey";
    players[5] = "Shikhar Dhawan";
    players[6] = "Ishan Kishan";
    players[7] = "Risabh Pant";
    players[8] = "Jasprit Bumrah";
    players[9] = "Bhuvaneshwar Kumar";
    players[10] = "Sanju Samson";
    players[11] = "Satyam Kumar";
    players[12] = "Gautam Gambhir";
    players[13] = "Suresh Raina";
    players[14] = "Harbhajan Singh";
    players[15] = "Yuvraj Singh";
    players[16] = "Rachin Ravindra";
    players[17] = "Mayank Yadav";
    players[18] = "Shashank Singh";
    players[19] = "Yuzvendra Chahal";
    players[20] = "Kuldeep Yadav";
    players[21] = "Rituraj Gayakwad";
